...
export const STRINGS: Record<Lang, Dict> = {
  ru: {
    ...
    selectCargoHint: "Клик — выбор груза, камера наводится на него",
  ...
  en: {
    ...
    selectCargoHint: "Click selects a cargo, the camera focuses on it",
